...
<main class="page-delivery">
  ...
  <section class="page-delivery__info">
    ...
    <ul class="page-delivery__list">
      <li>
       <b class="page-delivery__item-title">Стандартная доставка - <?= $shippCost ?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?= $freeDelivery ?> РУБ)</b>
      ...
      <li>
        <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?= $shippCost ?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?= $freeDelivery ?> РУБ)</b>
        <p class="page-delivery__item-desc">
